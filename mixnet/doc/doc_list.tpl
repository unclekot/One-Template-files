<div class="doc_block" style="margin-left:0px;margin-right:0px" id="doc_block{did}">
 ...
 <div class="button_div fl_l"><button class="button"  onClick="Doc.SaveEdit('{did}', 'editLnkDoc{did}')">Сохранить</button></div>
 <div class="button_div_gray fl_l margin_left"><button class="button"  onClick="Doc.CloseEdit('{did}', 'editLnkDoc{did}')">Отмена</button></div>
 </div>
 </div>
