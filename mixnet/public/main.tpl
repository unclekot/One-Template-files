...
<div class="medium-4 columns">
	<div class="ava" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
	...
	<div class="menuleft" style="margin-top:-2px">
	  ...
	  <span id="del_pho_but" class="no_display"><a href="/" onClick="groups.delphoto('{id}'); return false;"><div>Удалить фотографию</div></a></span>
	  ...
	  <div class="publick_subscblock">
	   <div id="yes" class="{yes}">
		<div class="button_div fl_l" style="margin-bottom:15px;line-height:15px"><button class="button" onClick="groups.login('{id}'); return false">Подписаться</button></div>
	...
	<div class="albtitle cursor_pointer" onClick="groups.all_people('{id}')">Подписчики</div>
	 ...
	 [feedback]<div class="albtitle cursor_pointer" onClick="groups.allfeedbacklist('{id}')">Контакты [yes][admin]<a href="/public{id}" class="fl_r" onClick="groups.allfeedbacklist('{id}'); return false">ред.</a>[/admin][/yes]</div>
	 ...
	 [audios]<div class="albtitle cursor_pointer" onClick="Page.Go('/public/audio{id}'); return false">Аудиозаписи</div>
	 <div class="public_bg">
...
<div class="medium-8 columns">
	<div class="profiewr profiewr2">
	 ...
	 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
	  ...
	  <div class="mgclr"></div>
	  <div class="texta">&nbsp;</div>
	   <div class="button_div fl_l"><button class="button" class="button" onClick="groups.saveinfo('{id}'); return false" id="pubInfoSave">Сохранить</button></div>
	   <div class="button_div_gray fl_l margin_left"><button class="button" onClick="groups.editformClose(); return false">Отмена</button></div>
	  <div class="mgclr"></div>
	 </div>
	 <div class="public_editbg fl_l no_display" id="edittab2">
	  ...
	  <div class="clear"></div>
	  <div class="button_div fl_l"><button class="button" onClick="groups.editform(); return false">Назад</button></div>
	 </div>[/admin]
	 </div>
	 </div>
	  <div class="page_bg border_radius_5 margin_top_10 page_bg_wall" style="padding-bottom:0px;padding-bottom:20px">
	 <div class="albtitle albtitle2" style="border-bottom:0px"><b id="rec_num">{rec-num}</b></div>
	 [admin][/admin]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
	  <input type="hidden" value="Что у Вас нового?" id="wall_input_text" />
	  <input type="text" class="msg_se_inp" value="Что у Вас нового?" onMouseDown="wall.form_open(); return false" id="wall_input"  />
	  <div class="no_display" id="wall_textarea">
	   ...
	   <div class="clear"></div>
	   <div class="button_div fl_l margin_top_10"><button class="button" onClick="groups.wall_send('{id}'); return false" id="wall_send">Отправить</button></div>
