[record]<div class="wallrecord wall_upage2 page_bg border_radius_5 margin_bottom_10" id="wall_record_{rec-id}" style="border:0px;padding:20px">
...
<div>
 ...
 [privacy-comment][comments-link]<div class="wall_fast_form no_display" id="fast_form_{rec-id}">
   <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
	...
	></textarea>
    <div class="button_div fl_l margin_top_5"><button class="button" onClick="wall.fast_send('{rec-id}', '{author-id}', 2); return false" id="fast_buts_{rec-id}">Отправить</button></div>
   </div>
   <div class="clear"></div>
