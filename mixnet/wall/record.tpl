[record]<div id="wall_records"><div class="wallrecord wall_upage page_bg border_radius_5 margin_top_10" id="wall_record_{rec-id}" style="padding:20px">
 <div style="float:left;width:10%"><div class="ava_mini [privacy-comment][if-comments]wall_ava_mini[/if-comments][/privacy-comment]" id="ava_rec_{rec-id}"><a href="/u{user-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" title="" /></a>{online}</div></div>
 ...
 <div class="size10 infowalltext_f clear">
  ...
  [privacy-comment][comments-link]<div class="wall_fast_form no_display" id="fast_form_{rec-id}">
   <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
	...
	></textarea>
    <div class="button_div fl_l margin_top_5"><button class="button" onClick="wall.fast_send('{rec-id}', '{author-id}'); return false" id="fast_buts_{rec-id}">Отправить</button></div>
   </div>
   <div class="clear"></div>
