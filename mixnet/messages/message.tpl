...
<div class="msg_one [new]msg_new[/new]" id="bmsg_{mid}">
 <div class="msg_pad">
  ...
  <a href="/messages/show/{mid}" onClick="Page.Go(this.href); return false"><div class="msg_right_col"><span class="mess_user">{subj}</span><div>{text}&nbsp;</div><div>{attach}</div></div></a>
