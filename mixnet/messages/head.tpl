...
<div class="button_div fl_l msg_pad_top"><button class="button" onClick="messages.search(); return false">Найти</button></div>
<div class="clear"></div>
</div>
<div class="msg_speedbar">&nbsp; &nbsp; <a href="/" style="font-weight:normal" onClick="im.settTypeMsg(); return false" id="settTypeMsg">{msg-type}</a></div>[/inbox]
...
<div class="button_div fl_l msg_pad_top"><button class="button" onClick="messages.search(1); return false">Найти</button></div>
<div class="clear"></div>
</div>
