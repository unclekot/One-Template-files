...
<div class="clear"></div>
<div class="button_div fl_l"><button class="button" onClick="messages.reply({user-id}, '[inbox]reply[/inbox][outbox]new[/outbox]'); return false" id="msg_sending">[inbox]Ответить[/inbox][outbox]Отправить[/outbox]</button></div>
