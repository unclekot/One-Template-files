[record]<div id="public_wall_records"><div class="wallrecord wall_upage public_wall page_bg border_radius_5 margin_top_10" id="wall_record_{rec-id}" style="padding:20px;border:0px">
 ...
 <div class="size10 infowalltext_f clear">
  ...
  [privacy-comment][comments-link]<div class="wall_fast_form no_display" id="fast_form_{rec-id}" style="margin-bottom:2px">
   <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
	...
	></textarea>
    <div class="button_div fl_l margin_top_5"><button class="button" onClick="groups.wall_send_comm('{rec-id}', '{user-id}'); return false" id="fast_buts_{rec-id}">Отправить</button></div>
   </div>
   <div class="clear"></div>
