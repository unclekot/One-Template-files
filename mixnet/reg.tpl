<h1 onClick="reg.step1(); return false" id="reg_lnk">Быстрая регистрация на сайте</h1>
<div class="note_add_bg support_bg" id="step1" style="margin-top:10px"><center>
!Пожалуйста, укажите <b>Ваше имя</b> и <b>фамилию</b>, это поможет Вашим друзьям находить Вас.</center>
...
<div class="button_div"><button class="button" onClick="reg.step1(); return false">Следующий шаг</button></div>
</div>
</div>

<div class="note_add_bg support_bg no_display" id="step2" style="margin-top:-10px"><center>
Пожалуйста, укажите Вашу <b>дату рождения</b>, <b>пол</b> и <b>страну проживания</b>.</center>
<div class="err_red no_display frmero" id="err" style="margin-bottom:0px"></div>
<div class="form-block">
...
<div class="button_div"><button class="button" onClick="reg.step2(); return false">Следующий шаг</button></div>
</div>
</div>

<div class="note_add_bg support_bg no_display" id="step3" style="margin-top:-10px"><center>
Укажите <b>Ваш электронный адрес</b> и <b>пароль</b>, который Вы будете использовать при входе.</center>
...
/>
<div class="input_hr"></div>
<div class="button_div"><button class="button" onClick="reg.finish(); return false">Отправить</button></div>
</div>
</div>
<br>
