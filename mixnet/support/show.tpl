 ...
 <div class="activetab"><a href="/support?act=show&qid=717" onClick="Page.Go(this.href); return false;">Просмотр вопроса</a></div>
</div>
...
<div class="clear"></div>
<div class="button_div fl_l" style="margin-left:60px"><button class="button" onClick="support.answer('{qid}', '{uid}'); return false" id="send">Отправить</button></div>
[group=4]<div class="button_div_nostl fl_r" id="close_but"><button class="button" onClick="support.close('{qid}'); return false" id="close">Закрыть вопрос</button></div>[/group]
<div class="clear"></div>
</div>