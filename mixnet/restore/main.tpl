...
/>
<div class="button_div fl_l margin_left" style="margin-top:11px"><button class="button" onClick="restore.next(); return false" id="send">Далее</button></div>
<div class="clear"></div>
...
<div class="clear"></div>
<div class="button_div fl_l" style="margin-top:11px"><button class="button" onClick="restore.send(); return false" id="send2">Да, это нужная страница</button></div>
<div class="clear"></div>
</div>
