...
<div class="photo_close" onClick="Photo.Close('{close-link}'); return false;"></div>
 <div class="photo_bg">
  ...
  [mark-block]<div class="mark_userid_bg" id="mark_userid_bg{id}">
   ...
   <div class="button_div_gray margin_left fl_r" style="margin-top:-5px"><button class="button" onClick="{mark-del-link}; return false">Удалить отметку</button></div>
   <div class="button_div fl_r" style="margin-top:-5px"><button class="button" onClick="Distinguish.OkUser({id}); return false">Потвердить</button></div>
   <div class="clear"></div>
  </div>[/mark-block]
  ...
  <div id="save_crop_text{id}" class="save_crop_text no_display" style="padding:20px;padding-left:0px">
   ...
   <div class="button_div_gray margin_left fl_r" style="margin-top:-5px"><button class="button" onClick="crop.close({id}); return false">Отмена</button></div>
   <div class="button_div fl_r" style="margin-top:-5px"><button class="button" onClick="crop.save({id}, {uid}); return false">Готово</button></div>
  </div>
  ...
  <div class="photo_leftcol">
   ...
   <div class="button_div fl_l"><button class="button" id="add_comm" onClick="comments.add({id}); return false">Отправить</button></div>[/add-comm]
   </div>
