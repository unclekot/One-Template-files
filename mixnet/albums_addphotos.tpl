...
<div class="button_div fl_l"><button class="button" id="upload">Выбрать фотографию</button></div>
<div class="button_div_gray fl_l" style="margin-left:10px;"><button class="button" onClick="Page.Go('/albums/view/{aid}'); return false;">Просмотр альбома</button></div>
</div>
