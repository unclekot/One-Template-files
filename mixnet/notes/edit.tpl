...
<input type="text" class="videos_input" maxlength="65" id="title_n" value="{title}" />
...
<textarea class="videos_input wysiwyg_inpt" id="text" name="text" style="margin:0px;padding:0px;width:778px">{text}</textarea>
<div class="input_hr"></div>
<div class="clear"></div>
<div class="button_div fl_l"><button class="button" onClick="notes.editsave({note-id}); return false" id="notes_sending">Сохранить изменения</button></div>
<div class="clear"></div>
</div>
</form>