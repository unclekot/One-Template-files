...
<input type="text" class="videos_input"  maxlength="65" id="title_n" />
...
<textarea class="videos_input wysiwyg_inpt" id="text" name="text"style="margin:0px;padding:0px;width:778px"></textarea>
<div class="clear"></div>
<div class="button_div fl_l"><button class="button" onClick="notes.send(); return false" id="notes_sending">Опубликовать</button></div>
<div class="clear"></div>
</div>
</form>