[record]
<div class="wallrecord comm_wr news_comm_wr page_bg border_radius_5 margin_bottom_10" id="wall_record_{rec-id}" style="padding:20px;border:0px">
<div style="float:left;width:10%"><div class="ava_mini hide-for-small-only"><a href="/{link}{author-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" /></a>{online}</div></div>
...
[wall]<div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}'[wall-func], 'uPages'[/wall-func])" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:585px">
...
<div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
 ...
 ></textarea>
  <div class="button_div fl_l margin_top_5">
   <button class="button" id="fast_buts_{rec-id}"
