...
<input type="text" class="videos_input" style="width:700px" maxlength="65" id="title" />
...
<div class="clear"></div>
<div class="button_div fl_l"><button class="button"  onClick="blog.add(); return false" id="notes_sending">Опубликовать</button></div>
<div class="clear"></div>
</div>
</form>